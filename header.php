<link rel="icon" type="image/png" href="/img/xvwa-logo-1.png" />
<div class="container">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/">XVWA</a>
    </div>
            ...
            <li class="dropdown" id="menuLogin">
                <?php
                    ...
                    if(isset($_SESSION['user'])){
                        ...
                        echo "<li><a href='".$XVWA_WEBROOT."/logout.php'>Logout</a></li>";
                        echo "</ul>";
                    }else{
                      ...
                      echo "<form class='form' method='POST' id='formLogin' action='".$XVWA_WEBROOT."/login.php'>"; 
